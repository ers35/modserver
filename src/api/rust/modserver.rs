...
extern {
  ...
  pub fn get_header(s: *mut Servlet, key: *const c_char) -> *const c_char;
  pub fn set_status(s: *mut Servlet, status: u32);
  pub fn set_header(s: *mut Servlet, key: *const c_char, value: *const c_char);
  pub fn set_content_length(s: *mut Servlet, length: usize);
